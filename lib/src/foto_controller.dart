...
class FotoController extends ValueNotifier<CameraValue> {
  FotoController(
    CameraDescription description,
  ...
  Future<void> _initializeWithDescription(CameraDescription description) async {
    if (_isDisposed) {
      throw CameraException(
        'Disposed FotoController',
        'initialize was called on a disposed FotoController',
      );
    }
  ...
  void _throwIfNotInitialized(String functionName) {
    if (!value.isInitialized) {
      throw CameraException(
        'Uninitialized FotoController',
        '$functionName() was called on an uninitialized FotoController.',
      );
    }
    if (_isDisposed) {
      throw CameraException(
        'Disposed FotoController',
        '$functionName() was called on a disposed FotoController.',
      );
    }
  }
